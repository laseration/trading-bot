...
const config = {
  ...
  safetyControls: {
    ...
    eurusdBiasAllowRanging: envFlag("EURUSD_BIAS_ALLOW_RANGING", false),
    eurusdBiasAllowUnstable: envFlag("EURUSD_BIAS_ALLOW_UNSTABLE", false),
    eurusdBiasAllowLateNewYork: envFlag("EURUSD_BIAS_ALLOW_LATE_NEWYORK", false),
    eurusdFailedZoneEscalationEnabled: envFlag("EURUSD_FAILED_ZONE_ESCALATION_ENABLED", true),
    eurusdGlobalLossCooldownMinutes: Number(process.env.EURUSD_GLOBAL_LOSS_COOLDOWN_MINUTES || 30),
    eurusdOverlapScoreBonus: Number(process.env.EURUSD_OVERLAP_SCORE_BONUS || 5),
    eurusdNewYorkMinFinalRr: Number(process.env.EURUSD_NEWYORK_MIN_FINAL_RR || 1.5),
    eurusdLondonMinFinalRr: Number(process.env.EURUSD_LONDON_MIN_FINAL_RR || 1.4),
    ...
    eurusdRangingBiasZoneSize: Number(process.env.EURUSD_RANGING_BIAS_ZONE_SIZE || 0.0005),
    eurusdFailedZoneCooldownMinutes: Number(process.env.EURUSD_FAILED_ZONE_COOLDOWN_MINUTES || 90),
  },
  hybrid: {
